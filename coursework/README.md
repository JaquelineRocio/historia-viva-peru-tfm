...
Mantenimiento de Actions registrado en `101e390`: acciones de los cuatro workflows actualizadas a `checkout@v6`, `setup-node@v6`, `setup-python@v6` y `upload-artifact@v6`, que ejecutan internamente Node 24. Validación local con actionlint correcta y ejecución remota de CI, mantenimiento y despliegue Modal comprobada para `328ab3c`. La ejecución remota del workflow Production smoke sigue pendiente. Esto atiende el [aviso de retirada de Node 20 en Actions](https://github.blog/changelog/2025-09-19-deprecation-of-node-20-on-github-actions-runners/). Un futuro runner propio de BETO deberá tener versión 2.327.1 o superior para estas acciones.
...
Siguiente bloque: ejecutar **Production smoke** desde GitHub Actions y conservar su resultado remoto. Después, completar el recorrido visual PDF → predicción automática → corrección persistida para la Unidad I.
