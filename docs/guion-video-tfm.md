...
Muestre una diapositiva: React, NestJS, PostgreSQL/pgvector, FastAPI, R2 y Hugging
Face. Destaque trazabilidad por página o minuto.
...
**Añadir y procesar**. Pase a una fuente ya lista.
...
Muestre 814 segmentos, split por fuente y resultados: TF-IDF 0.353, BETO 0.425,
Kappa 0.651. Diga explícitamente que BETO es experimental.
