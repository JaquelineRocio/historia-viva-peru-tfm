...
ML_SUPADATA_API_KEY: clave privada de Supadata
```
...
después de un periodo inactivo tendrá un arranque en frío. Para YouTube, el flujo
intenta primero subtítulos directos, después Supadata ante bloqueos de IP y por
último Whisper. Supadata tiene cuota gratuita limitada y Whisper puede ser lento;
conviene llevar una fuente ya procesada para la defensa.
